...
const New_Arival = () => {
  return (
    <div className='mt-[8rem] md:mt-0 bg-white'>
      <h1 className='integral text-center mt-[4.5rem] md:mt-[8.2rem] mb-8 text-[30px] md:text-[40px] font-bold'>NEW ARRIVALS</h1>
      <div className='flex m-auto w-[100%] md:gap-5 justify-center'>
        <div className="card px-2">
            <Image src={card1} alt="cross" />
            <h3 className="text-[12px] md:text-[20px] leading-[27px] mt-[10px] text-left px-1 md:px-2 mb-[5px] text-[#000000] font-[700]">T-shirt With Tape Details</h3>
            <div className="flex gap-1 md:gap-3 px-1 mb-[5px]">
              <Image src={m1} alt="m1"/>
              <p className="text-[#000000] text-[14px] leading-[18.9px] font-[400]">4.5<span className="text-[14px] text-[#BFBFBF] font-[400]">/5</span></p>
            </div>
            <h4 className="text-[18px] md:text-[24px] ml-[5px] leading-[32.4px] font-[700]">$120</h4>
        </div>
        <div className="card px-2">
            <Image src={card2} alt="cross" />
            <h3 className="text-[12px] md:text-[20px] leading-[27px] mt-[10px] text-left px-1 md:px-2 mb-[5px] text-[#000000] font-[700]">Skiny Fit Jeans</h3>
            <div className="flex gap-1 md:gap-3 px-1 mb-[5px]">
            ...
            <div className='flex ml-[5px] gap-1 md:gap-2 items-center'>
                <h2 className="text-[18px] md:text-[24px] leading-[32.4px] font-[700]">$240</h2>
                <h2 className="text-[18px] md:text-[24px] leading-[32.4px] line-through font-[700] text-[#BFBFBF]">$260</h2>
                <h3 className="bg-[#FFEBEB] w-[58px] h-[28px] flex items-center justify-center rounded-[62px] text-[10px] md:text-[12px] leading-[16.2px] text-[#FF3333]">-20%</h3>
            </div>
        </div>
      ...
      <div className="flex justify-center mt-[50px]">
        <Link href={"/category"}><button className='card w-[100%] mb-[10px] md:mb-[50px] border-[2px] hover:bg-[#ececec] rounded-full px-10 py-2 md:px-20 md:py-4'>View All</button></Link>
      </div>

      <div className="">
      <h1 className='integral text-center mt-[2.5rem] md:mt-[8.2rem] mb-8 text-[30px] md:text-[40px] font-bold'>TOP SELLING</h1>
      <div className='flex m-auto w-[100%] md:gap-5 justify-center'>
        <div className="card px-2">
            <Image src={Piccc1} alt="piccc1" />
            <h3 className="text-[12px] md:text-[20px] leading-[27px] mt-[10px] text-left px-1 md:px-2 mb-[5px] text-[#000000] font-[700]">Vertical Striped Shirt</h3>
            <div className="flex gap-3 ml-[5px] mb-[5px]">
            ...
            <div className='flex ml-[5px] gap-1 md:gap-2 items-center'>
                <h2 className="text-[18px] md:text-[24px] leading-[32.4px] font-[700]">$212</h2>
                <h2 className="text-[18px] md:text-[24px] leading-[32.4px] line-through font-[700] text-[#BFBFBF]">$232</h2>
                <h3 className="bg-[#FFEBEB] w-[58px] h-[28px] flex items-center justify-center rounded-[62px] text-[10px] md:text-[12px] leading-[16.2px] text-[#FF3333]">-20%</h3>
            </div>
        </div>
        <div className="card px-2">
            <Image src={Piccc2} alt="piccc2" />
            <h3 className="text-[12px] md:text-[20px] leading-[27px] mt-[10px] text-left px-1 md:px-2 mb-[5px] text-[#000000] font-[700]">Courage Graphics T-shirt</h3>
            <div className="flex gap-3 ml-[5px] mb-[5px]">
            ...
            <h2 className="text-[18px] md:text-[24px] leading-[32.4px] font-[700]">$145</h2>
        </div>
        <div className="card hidden sm:inline-block">
    ...
    <div className="w-auto sm:w-[1239px] m-2 md:m-4 sm:m-auto h-auto rounded-[40px] bg-[#F0F0F0] mt-[3rem] md:mt-[7rem]">
        <h1 className="integral text-[#000000] text-center font-[700] text-[30px] px-2 md:text-[45px] mb-[20px] md:mb-[50px] pt-[20px] md:pt-[50px] leading-[57.6px]">BROWSE BY DRESS STYLE</h1>
        <div className="w-[90%] m-auto">
          <div className="flex flex-col sm:flex-row mb-[-30px] gap-0 sm:gap-6">
            <div className="card cursor-pointer">
              ...
              <h3 className="text-[#000000] text-[28px] md:text-[36px] font-[700] relative bottom-[220px] sm:bottom-[260px] left-[30px]">Casual</h3>
            </div>
            <div className="card cursor-pointer mb-6 md:mb-0">
              <Image className="rounded-[20px] h-[15rem] sm:h-auto" src={image2} alt="image2"></Image>
              <h3 className="text-[#000000] text-[28px] md:text-[36px] font-[700] relative bottom-[220px] sm:bottom-[260px] left-[30px]">Formal</h3>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row mb-[-30px] gap-0 sm:gap-6">
            <div className="card cursor-pointer">
            <Image className="rounded-[20px] w-[684] bg-[white] h-[15rem] sm:h-auto border-l-white border-l-[50px]" src={image3} alt="image3"></Image>
            <h3 className="text-[#000000] text-[28px] md:text-[36px] font-[700] relative bottom-[220px] sm:bottom-[260px] left-[30px]">Party</h3>
            </div>
            <div className="card cursor-pointer">
            <Image className="rounded-[20px] w-[407px] bg-[white] h-[15rem] sm:h-auto border-l-white border-l-[50px]" src={image4} alt="image4"></Image>
            <h3 className="text-[#000000] text-[28px] md:text-[36px] font-[700] relative bottom-[220px] sm:bottom-[260px] left-[30px]">Gym</h3>
            </div>
          </div>
        </div>
    </div>  
