  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row gap-3 md:gap-5">
        <h2 className="text-gray-600 text-[1.1rem]">Quantity:</h2>
        ...
        <button className="card satoshi bg-[#000000] rounded-[62px] w-[100%] md:w-[400px] h-[52px] text-[#FFFFFF] text-[16px] leading-[21.6px] font-[500] active:bg-[#575656] active:text-[black]">Add to Cart</button>
      </div>
    </div>
  )
}
